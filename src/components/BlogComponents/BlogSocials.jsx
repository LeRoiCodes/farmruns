...
function BlogSocials() {
  return (
    <div className='mt-5 p-10 bg-[#55A349] font-oswald text-white' style={{borderRadius:"30px", boxShadow: "0px 2px 4px 0px rgba(0, 0, 0, 0.25)"}}>
        ...
        <div>
            <Link to='/' className='flex gap-3 items-center mb-4'>
                ...
                <p className='font-normal text-2xl '>{"@FarmRuns"}</p>
            </Link>
            <Link to='/' className='flex gap-3 items-center mb-4'>
            ...
            <Link to='/' className='flex gap-3 items-center mb-4'>
                ...
                <p className='font-normal text-2xl '>{"customercare@farmruns.com"}</p>
            </Link>
        </div>
