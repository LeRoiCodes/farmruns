      ...
      <nav className="bg-white border-gray-200 py-2.5 text-[32px] font-nanum ">
        <div className="flex flex-wrap justify-between items-center ">
          ...
          <div className="flex items-center lg:order-2">
            <Link
              to="/"
              className="hover:bg-gray-50 focus:ring-4 focus:ring-[#55A349]  rounded-lg px-3 lg:px-4 py-2 mr-1 focus:outline-none"
            >
              <img src={searchImg} className="w-[24px]" alt="search" />
            </Link>
            <Link
              to="/"
              className="hover:bg-gray-50 focus:ring-4 focus:ring-[#55A349]  rounded-lg px-3 lg:px-4 py-2 mr-1 focus:outline-none hidden lg:block"
            >
              <img src={storeImg} className="w-[24px]" alt="store" />
            </Link>
            <Link
              to="/login"
              className="text-white bg-[#55A349] hover:bg-white hover:text-black focus:ring-4 focus:ring-[#55A349] rounded-lg px-3 lg:px-4 py-2 focus:outline-none"
            >
              Login
            </Link>
            <button
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <Link
                  to="/"
                  className="block py-2 pr-4 pl-3 text-white rounded bg-[#55A349] lg:bg-transparent lg:text-[#55A349] lg:p-0"
                  aria-current="page"
                >
                  Home
                </Link>
