    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 text-[32px] font-nanum">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
                <Link to="/" className="hover:bg-gray-50 focus:ring-4 focus:ring-[#55A349]  rounded-lg px-3 lg:px-4 py-2 mr-2 focus:outline-none">
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <Link to="/" className="block py-2 pr-4 pl-3 text-black border-b border-[#55A349] hover:bg-[#b5f9aa] lg:hover:bg-transparent lg:border-0 lg:hover:text-[#55A349] lg:p-0">Company</Link>
                    </li>
                    <li>
